...
const XAI_GROK_420_CONTEXT_WINDOW = 1_000_000;
...
const XAI_MODEL_CATALOG = [
  ...
  },
  {
    ...
    reasoning: true,
    input: ["text", "image"],
    contextWindow: XAI_GROK_420_CONTEXT_WINDOW,
    maxTokens: 30_000,
...
export function resolveXaiCatalogEntry(modelId: string) {
  ...
  if (
    ...
    return toModelDefinition({
      ...
      input: ["text", "image"],
      contextWindow:
        lower.startsWith("grok-4.6") || lower.startsWith("grok-4.5")
          ? 500_000
          : lower.startsWith("grok-4.3")
            ? XAI_DEFAULT_CONTEXT_WINDOW
            : lower.startsWith("grok-4.20")
              ? XAI_GROK_420_CONTEXT_WINDOW
              : XAI_LARGE_CONTEXT_WINDOW,
      maxTokens:
        lower.startsWith("grok-4.6") || lower.startsWith("grok-4.5") || lower.startsWith("grok-4.3")
