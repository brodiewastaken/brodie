...
export type SessionsArchiveParams = SchemaType<"SessionsArchiveParams">;
export type SessionsArchiveResult = SchemaType<"SessionsArchiveResult">;
export type SessionArchiveResultRow = SchemaType<"SessionArchiveResultRow">;
