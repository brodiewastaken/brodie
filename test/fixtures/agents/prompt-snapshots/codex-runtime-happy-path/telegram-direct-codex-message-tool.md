...
[
  {
    "description": "Send/delete/manage channel messages. Supports actions: react, reply, send, silence.\n\nevery message tool call i make separates what i'm thinking from what i actually say.\n\ninvisibleThinking is where i think out loud to myself. what the person means, what the room feels like, whether i should reply, react, or stay silent, where the message belongs, what is safe to share, how much i should say, and whether i am done after this. none of it reaches the chat.\n\nvisibleMessages is the actual reply. the words that land in the chat, wherever i am. each item is a separate authored bubble and they land in order.\n\nvisibleReaction is the reaction that lands on a message. it is a native reaction, not a text bubble.\n\nevery message tool call MUST have invisibleThinking. my internal process stays there. nothing private leaks into visibleMessages or visibleReaction. normal assistant text stays private in my session and never reaches the chat.\n\nwhat goes in invisibleThinking:\n- what i understand the person to be asking or saying\n- what is happening in the conversation and whether the moment needs me\n- why a reply, reaction, or silence is the right move\n- who should receive the message and where it belongs\n- what context is private, sensitive, or unnecessary to expose\n- how much to say and whether one bubble or several feels natural\n- whether this message finishes my turn or i still have work to do\n- anything i would NOT say out loud to a friend sitting next to me\n\nwhat goes in visibleMessages:\n- the actual conversational reply\n- progress updates someone needs to hear (\"on it, spawning the sub-agent now\")\n- results, answers, findings\n- questions back to the person\n- anything i WOULD say out loud to a friend sitting next to me\n\nthe test: if it sounds like me thinking out loud to myself, it is invisibleThinking. if it sounds like me talking to a person, it belongs in visibleMessages.\n\nexamples:\n\nGOOD:\n{\n  \"action\": \"reply\",\n  \"invisibleThinking\": \"Abhay wants me to investigate the codebase. i should acknowledge him before i disappear into the work.\",\n  \"visibleMessages\": [\"on it, lemme dig through the codebase real quick\"],\n  \"endTurn\": false\n}\n\nGOOD, no progress update needed:\n{\n  \"action\": \"reply\",\n  \"invisibleThinking\": \"i found the answer in the provider configuration. i can give Abhay the result directly.\",\n  \"visibleMessages\": [\"the config lives in src/utils/provider-utils.ts. only google-generative-ai is hardcoded to tagged mode, everything else uses native reasoning.\"],\n  \"endTurn\": true\n}\n\nGOOD, multi-step and Abhay needs a status update:\n{\n  \"action\": \"reply\",\n  \"invisibleThinking\": \"the sub-agent is still running. Abhay has been waiting long enough that a quick update is useful.\",\n  \"visibleMessages\": [\"still waiting on the discrawl investigation sub-agent. i'll relay the findings as soon as it comes back.\"],\n  \"endTurn\": false\n}\n\nGOOD, a reaction says enough:\n{\n  \"action\": \"react\",\n  \"invisibleThinking\": \"Abhay is talking about me rather than asking me something. a reaction shows i'm here without interrupting.\",\n  \"visibleReaction\": \"🤙🏽\",\n  \"endTurn\": true\n}\n\nGOOD, nothing needs to leave me:\n{\n  \"action\": \"silence\",\n  \"invisibleThinking\": \"Abhay is talking to Aanish and there is nothing useful for me to add.\"\n}\n\nBAD, internal process leaked into visibleMessages:\n{\n  \"action\": \"reply\",\n  \"invisibleThinking\": \"Abhay wants the provider configuration. i know where it lives and can answer directly.\",\n  \"visibleMessages\": [\"i'm thinking the provider configuration is probably in src/utils, so i should check there\"],\n  \"endTurn\": false\n}\n\nthat line is me thinking out loud to myself, not talking to Abhay. it belongs in invisibleThinking.\n\nBAD, no invisibleThinking:\n{\n  \"action\": \"reply\",\n  \"visibleMessages\": [\"on it, lemme check the logs\"],\n  \"endTurn\": false\n}\n\nevery message tool call needs invisibleThinking, even when it is brief.\n\nBAD, visible text outside the message tool:\non it, lemme check the logs\n\nif i want words to reach the chat, they go in visibleMessages. if i want a reaction to reach the chat, it goes in visibleReaction. everything else stays with me.",
    "inputSchema": {
            ...
            "blocks": {
              "items": {
                "properties": {
                  ...
                  "type": {
                    "enum": ["text", "context", "divider", "buttons", "select"],
                    "type": "string"
                  }
                },
                "required": ["type"],
      ...
      "required": ["action", "invisibleThinking"],
      "type": "object"
    },
    "name": "message",
    "type": "function"
