...
export const de: TranslationMap = {
  ...
  chat: {
    ...
    transcript: {
      ...
      standard: "standard",
      raw: "raw",
      authoredMessage: "authored message",
      persistedInboundEnvelope: "persisted inbound envelope",
      capturedCurrentTurnTextInput: "captured current-turn text input · {count} items",
      currentUser: "current user",
      runtimeContext: "runtime context",
      userItem: "user item",
      tailUserItem: "tail user item",
      exactPersistedRow: "exact persisted row",
      toolInput: "input",
      toolCall: "tool call",
      toolResult: "tool result",
      nativeThinking: "model thinking · native · unsent",
      privateThought: "action rationale · unsent",
      committedReceipt: "committed delivery receipt",
    },
    workspaceFiles: {
