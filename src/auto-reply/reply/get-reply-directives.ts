...
import { isFastModeEnforcedOff, resolveFastModeState } from "../../agents/fast-mode.js";
...
export async function resolveReplyDirectives(params: {
  ...
  const resolvedFastMode = isFastModeEnforcedOff(cfg) ? false : requestedFastMode;
