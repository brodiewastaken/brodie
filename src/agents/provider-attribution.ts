...
import { getPluginManifestMetadataSnapshot } from "../plugins/manifest-metadata-cache.js";
import type { PluginManifestMetadataRecord } from "../plugins/manifest-metadata-scan.js";
...
function loadManifestProviderEndpointCache(): ManifestProviderEndpointCacheEntry[] {
  const snapshot = getPluginManifestMetadataSnapshot();
