...
export function buildSubagentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "5. **Trust push-based completion** - Descendant results are durably scheduled back to you. End the turn naturally when you need to wait; do not busy-poll for status.",
  ...
  if (canSpawn) {
    lines.push(
      ...
      "If required completions have not arrived yet, end the turn naturally. Do not invent polling loops; the runtime will resume this controller after durable completion admission.",
