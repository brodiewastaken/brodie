...
export function createSkillWorkshopTool(options: SkillWorkshopToolOptions): AnyAgentTool {
  return {
    ...
    description:
      "Create, update, revise, list, inspect, apply, reject, or quarantine proposals for workspace-owned skills. Shared/global and bundled/plugin skills require their own authorized maintenance route.",
