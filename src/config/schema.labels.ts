...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.qmd.paths.preserveName": "QMD Preserve Path Name",
  "memory.qmd.paths.includeByDefault": "QMD Include Path by Default",
  "memory.qmd.sessions.enabled": "QMD Session Indexing",
  "memory.qmd.sessions.exportDir": "QMD Session Export Directory",
  "memory.qmd.sessions.name": "QMD Session Collection Name",
