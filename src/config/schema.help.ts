...
export const FIELD_HELP: Record<string, string> = {
  ...
  "memory.qmd.paths.includeByDefault":
    "Controls whether unscoped QMD searches include this collection (default: true). Set false for an opt-in collection selected through an explicit collection filter.",
  ...
  "agents.defaults.model.fallbackNotice":
    'Controls user-visible model fallback transition and recovery notices. Use "silent" to keep fallback state and diagnostics without sending status banners; default is "visible".',
  ...
  "channels.defaults.contextVisibility":
    'Default supplemental context visibility for fetched quote/thread/history content: "all" (keep all context), or "allowlist" / "allowlist_quote" (always keep explicit quotes and filter other context by sender).',
  ...
  "channels.modelByChannel":
    "Map provider -> channel id / DM peer id -> model override (values are provider/model, aliases, or { model, thinking, fastMode }).",
